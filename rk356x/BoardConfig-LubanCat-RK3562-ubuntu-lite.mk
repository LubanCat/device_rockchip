...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rk3562
# Uboot image format type: fit(flattened image tree)
export RK_UBOOT_FORMAT_TYPE=fit
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=lubancat_linux_rk3562_defconfig
# Kernel defconfig fragment
export RK_KERNEL_DEFCONFIG_FRAGMENT=
# Kernel dts
export RK_KERNEL_DTS=rk3562-lubancat-a2io
# boot image type
...
# yocto machine
export RK_YOCTO_MACHINE=rockchip-rk3562-evb
# rootfs image path
